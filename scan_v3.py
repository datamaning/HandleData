...
#for word,times in counter.most_common(1000):
    #print word,times
projectlist=['Aqueryes','Archiver','B_PROC','BsostEdit','Chk_Sys','ClassifEdit','Common','ConsoleAdmin','Container','Custom','DBase','DBDump','DDSManager','FrameControl','FrameCore','HOST','Map'\
             ,'MessageNavigator','MonGPSCr','NetDLL','Nsi','NsiEdit','Probability','Queryes','Report','SecureMng','SecureUser','Space2','Starter','State','Tasks','UProfile','UserMonitor',\
             'UserTasks']
